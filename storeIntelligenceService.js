...
`{`,
`  "insight": "Provide ONE specific, actionable insight based ONLY on the data above. If limited data, focus on practical staffing or operational advice for the current time.",`,
      ...
      ``,
      `DECISION GUIDELINES:`,
`- If NO events/traffic/weather issues: Focus on staffing optimization for the current time`,
`- Saturday evening baseline: Typically 20-30% busier than weekdays`,
